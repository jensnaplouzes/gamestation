    ...
    <div class="container">
      ...
      <section class="space-y-8 mt-20">
        ...
        <div class="flex flex-wrap gap-10 justify-center mb-8">
          <template v-for="(char, index) in spidermancharacters.slice(0, 3)" :key="index">
            <div class="text-center">
              <Card
                :name="char.name"
                :image="char.image"
                :onClick="
                  () => (activeCardspiderman = activeCardspiderman === index ? null : index)
                "
              />
        ...
        <div class="flex flex-wrap gap-10 justify-center">
          <template v-for="(char, index) in spidermancharacters.slice(3, 6)" :key="index">
            <div class="text-center">
              <Card
                :name="char.name"
                :image="char.image"
...
const activeCardspiderman = ref(null);
